...
{{--<div class="modal-body bg-dark text-white p-4 rounded shadow">--}}
    <div class="modal-body bg-dark text-white p-4 rounded shadow" style="overflow-y:auto; max-height: 80vh;">
        ...
        <div class="row">
            ...
            <div class="form-group col-md-6 mb-3">
                ...
                @if($contentMaster->thumbnail)
                    <p>Current: <a href="{{ asset('storage/' . $contentMaster->thumbnail) }}" target="_blank">View Thumbnail</a></p>
                @endif
            </div>
            ...
            <div class="form-group col-md-6 mb-3">
                ...
                @if($contentMaster->full_video_url)
                    <p>Current: <a href="{{ $contentMaster->full_video_url }}" target="_blank">View Video</a></p>
                @endif
            </div>
